  ...
  return (
    <div className="educators-wrap copy-wrap">
      ...
      <h2>Lesson Plans</h2>
        ...
        <h2>Slides</h2>
        <p>You can find Google Slide versions of the powerpoints used for each lesson in this Google Folder. Feel free to download these slides or make a copy to edit so that they suit your needs. There are two slide decks: one for each lesson length.</p>
        <h2>Assessment</h2>
        <p>We developed a pre- and post-assessment to assess student learning outcomes for both lesson lengths. We recommend grading students based on their improvement if you decide to use both the pre- and post-assessment. You can also grade based on “correctness” if using only the post-assessment. You can modify either assessment to better suit your needs/grading style. For answer keys, please email Aislyn at aislyn.keyes(at)colorado.edu</p>
